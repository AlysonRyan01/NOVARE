...
public class DecreaseStockHandler : IRequestHandler<DecreaseStockCommand, Result<Product>>
{
    private readonly IProductCommandRepository _productCommandRepository;
    private readonly IProductQueryRepository _productQueryRepository;
    private readonly IUnitOfWork _unitOfWork;
    private readonly IValidator<DecreaseStockCommand> _validator;

    public DecreaseStockHandler(
        IProductCommandRepository productCommandRepository, 
        IProductQueryRepository productQueryRepository, 
        IUnitOfWork unitOfWork, 
        IValidator<DecreaseStockCommand> validator)
    {
